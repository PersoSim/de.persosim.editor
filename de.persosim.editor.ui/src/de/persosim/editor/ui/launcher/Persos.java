...
public class Persos
{
	...
	private static void setAtCert(MasterFile mf) throws CertificateNotParseableException, AccessDeniedException
	{
		...
		TrustPointCardObject trustPointAt = new TrustPointCardObject(new TrustPointIdentifier(TerminalType.AT), new CardVerifiableCertificate(new ConstructedTlvDataObject(certData)));
