...
public class Persos
{
	...
	public static final int NUMBER_OF_PROFILES_BETA_PKI = 1;
	public static final int NUMBER_OF_PROFILES_TR03124 = 1;
	public static final int NUMBER_OF_PROFILES_ALL = NUMBER_OF_PROFILES_CLASSIC + NUMBER_OF_PROFILES_UB + NUMBER_OF_PROFILES_OA + NUMBER_OF_PROFILES_BETA_PKI + NUMBER_OF_PROFILES_TR03124;
		...
		try {
			...
			if (number == 0)
				...
				perso = getPerso(number - NUMBER_OF_PROFILES_CLASSIC - NUMBER_OF_PROFILES_UB, "ProfileOA", null);
					...
					&& number <= NUMBER_OF_PROFILES_CLASSIC + NUMBER_OF_PROFILES_UB + NUMBER_OF_PROFILES_OA + NUMBER_OF_PROFILES_BETA_PKI)
				perso = getPerso(number - NUMBER_OF_PROFILES_CLASSIC - NUMBER_OF_PROFILES_UB - NUMBER_OF_PROFILES_OA, "Profile", "BetaPki");
			else if (number > NUMBER_OF_PROFILES_CLASSIC + NUMBER_OF_PROFILES_UB + NUMBER_OF_PROFILES_OA + NUMBER_OF_PROFILES_BETA_PKI
					&& number <= NUMBER_OF_PROFILES_CLASSIC + NUMBER_OF_PROFILES_UB + NUMBER_OF_PROFILES_OA + NUMBER_OF_PROFILES_BETA_PKI + NUMBER_OF_PROFILES_TR03124)
				perso = getPerso(number - NUMBER_OF_PROFILES_CLASSIC - NUMBER_OF_PROFILES_UB - NUMBER_OF_PROFILES_OA - NUMBER_OF_PROFILES_BETA_PKI, "Profile", "Tr03124");
			else
